...
public:
    ...
    vector<int> procurarLinhas(int procurado) const {
        vector<int> linhas;
...
int main() {
    ...
    if (!valores.empty()) {
        ...
        vector<int> linhas = matrix.procurarLinhas(procurado);

        cout << "Matriz:" << endl;
        matrix.imprimir();

        if (!linhas.empty()) {
            cout << "O valor " << procurado << " foi encontrado na(s) linha(s): ";
            for (const auto& linha : linhas) {
                cout << linha << " ";
            }
            cout << endl;
        } else {
            cout << "O valor " << procurado << " nao foi encontrado na matriz." << endl;
        }
    } else {
