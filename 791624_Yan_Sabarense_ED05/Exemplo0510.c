...
int main()
{
    ...
    do
    {
        ...
        IO_println(" 3 - mostrar certa quantidade de valores pares(alternativa)");
        IO_println(" 4 - mostrar certa quantidade de valores pares(alternativa2)");
        IO_println(" 5 - mostrar certa quantidade de vlores pares(alternativa3)");
        IO_println(" 6 - mostrar soma de certa quantidade de valores pares");
        IO_println(" 7 - funcao para somar certa quantidade de fracoes");
        IO_println(" 8 - funcao para somar certa quantidade de fracoes(alternativa)");
        IO_println(" 9 - funcao para somar certa quantidade de fracoes(alternativa2)");
