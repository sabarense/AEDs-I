...
int main(int argc, char **argv)
{
    ...
    do
    {
        ...
        cout << " 8 - metodo para testar a igualdade de dois arranjos, posicao por posicao" << endl;
        cout << " 9 - operador para somar valores em dois arranjos, posicao por posicao" << endl;
