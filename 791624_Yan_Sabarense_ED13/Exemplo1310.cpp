...
int main(int argc, char **argv)
{
    ...
    do
    {
        ...
        cout << " 8 - Testar atribuicoes e tratamento de erro1 " << endl;
        cout << " 9 - Testar a atribuição de valores ao objeto " << endl;
        cout << " 10 - Testar a atribuição de valores ao objeto1 " << endl;
        // ler do teclado
        cout << endl
