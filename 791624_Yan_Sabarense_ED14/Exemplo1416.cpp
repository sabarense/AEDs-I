...
std::string toUpperCase(std::string texto)
{
    ...
    std::cout << "Texto em maiúsculas: " << textoMaiusculo << std::endl;
...
std::string toLowerCase(std::string texto)
{
    std::string resultado;
    ...
    std::cout << "Texto em minúsculas: " << textoMinusculo << std::endl;
...
int main(int argc, char **argv)
{
    ...
    do
    {
        ...
        cout << " 6 - to upper case " << endl;
        cout << " 7 - to lower case " << endl;
        // ler do teclado
        cout << endl
